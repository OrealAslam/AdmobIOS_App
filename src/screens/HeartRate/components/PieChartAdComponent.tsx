import {
        ...
        try {
          if(!props.hidead) {
            if (props.loader == false) {
              let adSeen = await get_async_data('pie_chart_heart_ad');
              setadSeen(adSeen);
            }
          } else{ 
            setadSeen('seen');
        ...
        {adSeen == 'seen' || props.hidead == true ? (
          <>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                props.navigation.navigate('RecordHeartRate');
              }}>
          ...
          <ImageBackground
            ...
            <View style={styles.descriptionContainer}>
              ...
              Watch an ad to unlock Heart Rate trends
              </Text>
            </View>
  ...
  const styles = StyleSheet.create({
    ...
    btn: {width: '80%', height: 196 * btnRatio, alignSelf: 'center'},
    btnText: {
      fontSize: 16,
